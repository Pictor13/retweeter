...
# max 5 minutes rate limit, according to docs (see https://developer.twitter.com/ja/docs/basics/rate-limits)
api_rate_limit = 5*60
...
def reply():
    ...
    for mention in reversed(mentions):
        ...
        if '#spininelfianco' in mention.text.lower():
